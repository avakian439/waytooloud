...
export class AudioController {
  ...
  public async startMonitoring(): Promise<boolean> {
    ...
    try {
      ...
      console.log('Microphone access granted', { deviceId: this.inputDeviceId });
  ...
  public setInputDevice(deviceId: string | null) {
  ...
  public setOutputDevice(deviceId: string | null) {
    this.outputDeviceId = deviceId;
  }

  public getOutputDevice() {
  ...
  public async listAudioDevices(): Promise<MediaDeviceInfo[]> {
    ...
    try {
      ...
      console.warn('Unable to list audio devices:', error);
      return [];
    }
  }
